...
<header>
    ...
    <div class="nav">
 	  <a href="jsp/分类.jsp?sort=1"<%if(sort.equals("科技")){%>style="color: red;"<%}%>>科技</a>
      <a href="jsp/分类.jsp?sort=2"<%if(sort.equals("学术")){%>style="color: red;"<%}%>>学术</a>
      <a href="jsp/分类.jsp?sort=3"<%if(sort.equals("美文")){%>style="color: red;"<%}%>>美文</a>
      <a href="jsp/分类.jsp?sort=4"<%if(sort.equals("教育")){%>style="color: red;"<%}%>>教育</a>
      <a href="jsp/分类.jsp?sort=5"<%if(sort.equals("娱乐")){%>style="color: red;"<%}%>>娱乐</a>
      <a href="jsp/分类.jsp?sort=6"<%if(sort.equals("财经")){%>style="color: red;"<%}%>>财经</a>
      <a href="jsp/分类.jsp?sort=7"<%if(sort.equals("景点")){%>style="color: red;"<%}%>>景点</a>
      <a href="jsp/分类.jsp?sort=8"<%if(sort.equals("国际")){%>style="color: red;"<%}%>>国际</a>
    </div>
   ...
   <div class="content whisper-content">
    <div class="cont">
      ...
      <%
      ArrayList<Article> articles =  new WisShowDao().getcomInfo(sort);
 	  if (articles == null){
                ...
                <form class="layui-form" method="post" action="AddComServlet">
                  ...
                  <div class="layui-form-item">
                    <div class="layui-input-block" style="text-align: right;">
                      <input type="submit" onclick="return check();" class="layui-btn definite" value="确定"/>
                    </div>
                  </div>
                </form>
